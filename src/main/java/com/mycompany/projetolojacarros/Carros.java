...
public class Carros extends JPanel {
    ...
    public Carros() {
        ...
        listaCarros = EmpacotamentoCarros.lerArquivosCarros("dados.dat");
    ...
    public class Handler1 implements ActionListener {
        ...
        public void actionPerformed(ActionEvent event) {
            ...
            if (marca1.getText().equals("") || modelo1.getText().equals("") || ano1.getText().equals("") || cor1.getText().equals("") || valor1.getText().equals("")) {
                JOptionPane.showMessageDialog(null, "Preencher todos os campos", "ERRO", JOptionPane.ERROR_MESSAGE);
            } else {

                Carros1 c = new Carros1(marca1.getText(), modelo1.getText(), ano1.getText(), cor1.getText(), valor1.getText());
                listaCarros.add(c);
    ...
    public class Handler6 implements ActionListener {
        ...
        public void actionPerformed(ActionEvent evento) {
            ...
            EmpacotamentoCarros.gravarArquivosCarros(listaCarros, "dados.dat");
            JOptionPane.showMessageDialog(null, "Gravado com sucesso", "Informação",
                    JOptionPane.INFORMATION_MESSAGE);
            atualizarTabela();
